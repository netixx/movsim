...
/**
 * The Class EquilibriumAT.
 */
class EquilibriumAT extends EquilibriumPropertiesImpl {
     ...
     *            the idm model
     */
    EquilibriumAT(double length, AutoTopoModel model) {
        super(length);
     ...
     *            the model
     */
    private void calcEquilibrium(AutoTopoModel model) {
